...
public class Account : FullAuditedAggregateRoot<Guid>, IMultiTenant
{
    ...
    public Account(Guid id, Guid? tenantId, [NotNull] string accountGroupName, Guid userId, decimal balance,
    ...
    [NotNull] public virtual string AccountGroupName { get; protected set; }
