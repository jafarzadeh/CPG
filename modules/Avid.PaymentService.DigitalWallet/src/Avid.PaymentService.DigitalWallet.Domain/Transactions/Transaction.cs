...
public class Transaction : CreationAuditedAggregateRoot<Guid>, IMultiTenant
{
    ...
    public Transaction(Guid id, Guid? tenantId, Guid accountId, Guid accountUserId, Guid? paymentId,
        TransactionType transactionType, [NotNull] string actionName, [NotNull] string paymentMethod,
        [CanBeNull] string externalTradingCode, [NotNull] string currency, decimal changedBalance,
    ...
    [NotNull] public virtual string ActionName { get; protected set; }
    [NotNull] public virtual string PaymentMethod { get; protected set; }
    [CanBeNull] public virtual string ExternalTradingCode { get; protected set; }
    [NotNull] public virtual string Currency { get; protected set; }
