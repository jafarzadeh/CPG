...
public class WithdrawalRecord : FullAuditedAggregateRoot<Guid>, IMultiTenant
{
    ...
    public WithdrawalRecord(Guid id, Guid? tenantId, Guid accountId, [NotNull] string withdrawalMethod,
    ...
    [NotNull] public virtual string WithdrawalMethod { get; protected set; }
    public virtual decimal Amount { get; protected set; }
    public virtual DateTime? CompletionTime { get; protected set; }
    public virtual DateTime? CancellationTime { get; protected set; }
    [CanBeNull] public virtual string ResultErrorCode { get; protected set; }
    [CanBeNull] public virtual string ResultErrorMessage { get; protected set; }
    ...
    public void Cancel(DateTime cancellationTime, [CanBeNull] string resultErrorCode,
