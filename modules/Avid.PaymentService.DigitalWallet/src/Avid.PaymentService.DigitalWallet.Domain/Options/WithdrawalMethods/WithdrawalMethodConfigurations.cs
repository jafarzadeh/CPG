...
public class WithdrawalMethodConfigurations
{
    ...
    {
        return Configure(WithdrawalMethodNameAttribute.GetWithdrawalMethodName<TWithdrawalMethod>(), configureAction);
    }

    public WithdrawalMethodConfigurations Configure([NotNull] string name,
        [NotNull] Action<WithdrawalMethodConfiguration> configureAction)
    {
        Check.NotNullOrWhiteSpace(name, nameof(name));
        Check.NotNull(configureAction, nameof(configureAction));
        configureAction(_withdrawalMethods.GetOrAdd(name, () => new WithdrawalMethodConfiguration()));
        return this;
    }
