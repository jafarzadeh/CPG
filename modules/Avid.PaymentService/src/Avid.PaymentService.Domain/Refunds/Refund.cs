...
public class Refund : FullAuditedAggregateRoot<Guid>, IRefund, IMultiTenant
{
    ...
    [NotNull] public virtual string RefundPaymentMethod { get; protected set; }
    ...
    [CanBeNull] public virtual string DisplayReason { get; protected set; }

    [CanBeNull] public virtual string CustomerRemark { get; protected set; }

    [CanBeNull] public virtual string StaffRemark { get; protected set; }
