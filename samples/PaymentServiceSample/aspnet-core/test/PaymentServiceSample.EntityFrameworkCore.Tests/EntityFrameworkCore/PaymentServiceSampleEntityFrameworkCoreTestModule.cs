...
[DependsOn(typeof(AbpEntityFrameworkCoreSqliteModule), typeof(PaymentServiceSampleEntityFrameworkCoreModule),
...
public class PaymentServiceSampleEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        connection.Open();
        var options = new DbContextOptionsBuilder<PaymentServiceSampleDbContext>().UseSqlite(connection).Options;
