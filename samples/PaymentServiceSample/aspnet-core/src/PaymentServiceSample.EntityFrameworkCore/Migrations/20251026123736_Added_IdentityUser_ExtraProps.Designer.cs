...
namespace PaymentServiceSample.Migrations
{
    ...
    [Migration("20251026123736_Added_IdentityUser_ExtraProps")]
    partial class Added_IdentityUser_ExtraProps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Avid.PaymentService.DigitalWallet.Accounts.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("Accounts", "PaymentServiceDigitalWallet");
                });

            modelBuilder.Entity("Avid.PaymentService.DigitalWallet.Transactions.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Transactions", "PaymentServiceDigitalWallet");
                });

            modelBuilder.Entity("Avid.PaymentService.DigitalWallet.WithdrawalRecords.WithdrawalRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WithdrawalRecords", "PaymentServiceDigitalWallet");
                });

            modelBuilder.Entity("Avid.PaymentService.DigitalWallet.WithdrawalRequests.WithdrawalRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WithdrawalRequests", "PaymentServiceDigitalWallet");
                });

            modelBuilder.Entity("Avid.PaymentService.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Payments", "PaymentService");
                });

            modelBuilder.Entity("Avid.PaymentService.Payments.PaymentItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PaymentItems", "PaymentService");
                });

            modelBuilder.Entity("Avid.PaymentService.Refunds.Refund", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Refunds", "PaymentService");
                });

            modelBuilder.Entity("Avid.PaymentService.Refunds.RefundItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RefundItems", "PaymentService");
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasIndex("NationalCode", "TenantId")
                        .IsUnique()
                        .HasFilter("[NationalCode] IS NOT NULL AND [TenantId] IS NOT NULL");
            ...
            modelBuilder.Entity("Avid.PaymentService.Payments.PaymentItem", b =>
                {
                    b.HasOne("Avid.PaymentService.Payments.Payment", null)
            ...
            modelBuilder.Entity("Avid.PaymentService.Refunds.RefundItem", b =>
                {
                    b.HasOne("Avid.PaymentService.Refunds.Refund", null)
